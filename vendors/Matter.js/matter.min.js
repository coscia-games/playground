  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      (i.create = function (e, t) {
        ...
        (i.centre = function (e) {
          for (var t, n, r, a = i.area(e, !0), s = { x: 0, y: 0 }, l = 0; l < e.length; l++)
            (r = (l + 1) % e.length), (t = o.cross(e[l], e[r])), (n = o.mult(o.add(e[l], e[r]), t)), (s = o.add(s, n));
          return o.div(s, 6 * a);
        }),
        (i.mean = function (e) {
          for (var t = { x: 0, y: 0 }, n = 0; n < e.length; n++) (t.x += e[n].x), (t.y += e[n].y);
        ...
        (i.translate = function (e, t, n) {
          var i;
          if (n) for (i = 0; i < e.length; i++) (e[i].x += t.x * n), (e[i].y += t.y * n);
          ...
          for (var s = [], l = 0; l < e.length; l++) {
            ...
            if (0 !== p) {
              var f = o.normalise({ x: u.y - c.y, y: c.x - u.x }),
                ...
                h = n;
              -1 === n && (h = 1.75 * Math.pow(p, 0.32)), (h = r.clamp(h, i, a)) % 2 == 1 && (h += 1);
              for (var b = Math.acos(o.dot(f, v)) / h, S = 0; S < h; S++) s.push(o.add(o.rotate(y, b * S), x));
            } else s.push(u);
          }
          return s;
        }),
    ...
    function (e, t, n) {
      ...
      (i.create = function (e) {
        ...
        (i.setModified = function (e, t, n, o) {
          if (((e.isModified = t), n && e.parent && i.setModified(e.parent, t, n, o), o))
        ...
        (i.removeComposite = function (e, t, n) {
          ...
          if ((-1 !== o && (i.removeCompositeAt(e, o), i.setModified(e, !0, !0, !1)), n))
        ...
        (i.removeBody = function (e, t, n) {
          ...
          if ((-1 !== o && (i.removeBodyAt(e, o), i.setModified(e, !0, !0, !1)), n))
        ...
        (i.rotate = function (e, t, n, o) {
          for (var r = Math.cos(t), a = Math.sin(t), l = o ? i.allBodies(e) : e.bodies, c = 0; c < l.length; c++) {
            var u = l[c],
              d = u.position.x - n.x,
              p = u.position.y - n.y;
            s.setPosition(u, { x: n.x + (d * r - p * a), y: n.y + (d * a + p * r) }), s.rotate(u, t);
          }
          return i.setModified(e, !0, !0, !1), e;
        }),
        (i.scale = function (e, t, n, o, r) {
          for (var a = r ? i.allBodies(e) : e.bodies, l = 0; l < a.length; l++) {
            var c = a[l],
              u = c.position.x - o.x,
              d = c.position.y - o.y;
            s.setPosition(c, { x: o.x + u * t, y: o.y + d * n }), s.scale(c, t, n);
          }
          return i.setModified(e, !0, !0, !1), e;
        }),
        (i.bounds = function (e) {
      ...
      !(function () {
        ...
        (i.set = function (e, t, n) {
          ...
          (i.setCentre = function (e, t, n) {
            n
              ? ((e.positionPrev.x += t.x), (e.positionPrev.y += t.y), (e.position.x += t.x), (e.position.y += t.y))
          ...
          (i.rotate = function (e, t, n) {
            if (n) {
              var o = Math.cos(t),
                ...
                a = e.position.x - n.x,
                s = e.position.y - n.y;
              i.setPosition(e, { x: n.x + (a * o - s * r), y: n.y + (a * r + s * o) }), i.setAngle(e, e.angle + t);
          ...
          (i.update = function (e, t, n, i) {
            ...
            (e.velocity.x = u * s * i + (e.force.x / e.mass) * a),
              ...
              (e.angularVelocity = (e.angle - e.anglePrev) * s * i + (e.torque / e.inertia) * a),
              (e.anglePrev = e.angle),
          ...
          (i._totalProperties = function (e) {
            for (
              var t = { mass: 0, area: 0, inertia: 0, centre: { x: 0, y: 0 } }, n = 1 === e.parts.length ? 0 : 1;
              n < e.parts.length;
              n++
            ) {
              var i = e.parts[n],
      ...
      (i._motionWakeThreshold = 0.18),
            ...
            if (0 === r.force.x && 0 === r.force.y) {
              ...
              (r.motion = i._minBias * s + (1 - i._minBias) * l),
                r.sleepThreshold > 0 && r.motion < i._motionSleepThreshold * n
                  ? ((r.sleepCounter += 1), r.sleepCounter >= r.sleepThreshold && i.set(r, !0))
        ...
        (i.set = function (e, t) {
          ...
          t
            ...
            : ((e.isSleeping = !1), (e.sleepCounter = 0), n && o.trigger(e, "sleepEnd"));
        });
    },
    function (e, t, n) {
      var i = {};
      ...
      (i._warming = 0.4),
        ...
        (i.preSolveAll = function (e) {
          for (var t = 0; t < e.length; t += 1) {
            ...
            n.isStatic ||
              ...
              ((n.position.x += i.x), (n.position.y += i.y), (n.angle += i.angle));
          }
        }),
        ...
        (i.solve = function (e, t) {
          var n = e.bodyA,
            ...
            s = e.pointB;
          if (n || o) {
            n && !n.isStatic && (r.rotate(a, n.angle - e.angleA, a), (e.angleA = n.angle)),
              o && !o.isStatic && (r.rotate(s, o.angle - e.angleB, s), (e.angleB = o.angle));
            var l = a,
              c = s;
            if ((n && (l = r.add(n.position, a)), o && (c = r.add(o.position, s)), l && c)) {
              ...
              n &&
                ...
                (n.position.y -= h.y * f),
                e.damping &&
                  ((n.positionPrev.x -= e.damping * v.x * m * f), (n.positionPrev.y -= e.damping * v.y * m * f)),
                (p = (r.cross(a, h) / S) * i._torqueDampen * n.inverseInertia * (1 - e.angularStiffness)),
                ...
                o &&
                  ...
                  (o.position.y += h.y * f),
                  e.damping &&
                    ((o.positionPrev.x += e.damping * v.x * m * f), (o.positionPrev.y += e.damping * v.y * m * f)),
                  (p = (r.cross(s, h) / S) * i._torqueDampen * o.inverseInertia * (1 - e.angularStiffness)),
    ...
    function (e, t, n) {
      ...
      (i.rectangle = function (e, t, n, i, s) {
        ...
        (i.trapezoid = function (e, t, n, i, s, l) {
          ...
          c =
            s < 0.5
              ? "L 0 0 L " + u + " " + -i + " L " + d + " " + -i + " L " + p + " 0"
              : "L 0 0 L " + d + " " + -i + " L " + p + " 0";
          var f = { label: "Trapezoid Body", position: { x: e, y: t }, vertices: o.fromPath(c) };
          if (l.chamfer) {
            var v = l.chamfer;
        ...
        (i.polygon = function (e, t, n, s, l) {
          ...
          for (var c = (2 * Math.PI) / n, u = "", d = 0.5 * c, p = 0; p < n; p += 1) {
            var f = d + p * c,
              v = Math.cos(f) * s,
              m = Math.sin(f) * s;
            u += "L " + v.toFixed(3) + " " + m.toFixed(3) + " ";
          }
          var y = { label: "Polygon Body", position: { x: e, y: t }, vertices: o.fromPath(u) };
          if (l.chamfer) {
            var g = l.chamfer;
        ...
        (i.fromVertices = function (e, t, n, i, c, u, d, p) {
          ...
          for (
            ...
            if (
              ...
              (g = y ? o.clockwiseSort(g) : o.hull(g)), m.push({ position: { x: e, y: t }, vertices: g });
            else {
          ...
          return m.length > 1
            ? ((v = a.create(r.extend({ parts: m.slice(0) }, i))), a.setPosition(v, { x: e, y: t }), v)
            : m[0];
        });
    },
    function (e, t, n) {
      ...
      (i.create = function (e) {
        ...
        return (
          ...
          (t.sourceEvents = { mousemove: null, mousedown: null, mouseup: null, mousewheel: null }),
      ...
      (i.collisions = function (e, t) {
        for (var n = [], s = t.pairs.table, l = 0; l < e.length; l++) {
          var c = e[l][0],
            u = e[l][1];
          if (
            ((!c.isStatic && !c.isSleeping) || (!u.isStatic && !u.isSleeping)) &&
      ...
      (i.collides = function (e, t, n) {
        ...
        if (n) {
          var d = e.parent,
            p = t.parent,
            f =
              d.speed * d.speed + d.angularSpeed * d.angularSpeed + p.speed * p.speed + p.angularSpeed * p.angularSpeed;
        ...
        if (n && u) {
          ...
          if (((l = i._overlapAxes(v.vertices, m.vertices, y)), (c.reused = !0), l.overlap <= 0))
          ...
          a.overlap < s.overlap ? ((l = a), (c.axisBody = e)) : ((l = s), (c.axisBody = t)),
        ...
        var g = i._findSupports(e, t, c.normal),
          x = [];
        if (
          (o.contains(e.vertices, g[0]) && x.push(g[0]), o.contains(e.vertices, g[1]) && x.push(g[1]), x.length < 2)
        ) {
        ...
        (i._overlapAxes = function (e, t, n) {
          for (var o, a, s = r._temp[0], l = r._temp[1], c = { overlap: Number.MAX_VALUE }, u = 0; u < n.length; u++) {
            if (
              ((a = n[u]),
        ...
        (i._findSupports = function (e, t, n) {
          for (
            var i, o, a, s, l = Number.MAX_VALUE, c = r._temp[0], u = t.vertices, d = e.position, p = 0;
            p < u.length;
            p++
          )
    ...
    function (e, t, n) {
      ...
      (i._registry = {}),
        (i.register = function (e) {
          if (
            (i.isPlugin(e) || o.warn("Plugin.register:", i.toString(e), "does not implement all required fields."),
            ...
            n > r
              ? (o.warn("Plugin.register:", i.toString(t), "was upgraded to", i.toString(e)), (i._registry[e.name] = e))
              : n < r
                  ...
                  ? i.isUsed(e, l.name) ||
                    ...
                    l.install
                      ...
                      : (o.warn("Plugin.use:", i.toString(l), "does not specify an install function."),
                        (l._warned = !0)),
                    l._warned ? (a.push("🔶 " + i.toString(l)), delete l._warned) : a.push("✅ " + i.toString(l)),
                    e.used.push(l.name))
                  : a.push("❌ " + r[s]);
              }
      ...
      !(function () {
        ...
        "undefined" != typeof window &&
          ...
          (i.lookAt = function (e, t, n, i) {
            (i = void 0 === i || i), (t = o.isArray(t) ? t : [t]), (n = n || { x: 0, y: 0 });
            for (var r = { min: { x: 1 / 0, y: 1 / 0 }, max: { x: -1 / 0, y: -1 / 0 } }, a = 0; a < t.length; a += 1) {
              var s = t[a],
          ...
          (i.world = function (e, t) {
            ...
            if (
              ...
              for (n = 0; n < h.length; n++) {
                ...
                C && (_ = l.add(C.position, M.pointA)),
                  ...
                  _ && k && (a.contains(e.bounds, _) || a.contains(e.bounds, k)) && w.push(M);
              }
            ...
            !y.wireframes || (d.enableSleeping && y.showSleeping)
              ? i.bodies(e, S, m)
              : (y.showConvexHulls && i.bodyConvexHulls(e, S, m), i.bodyWireframes(e, S, m)),
          ...
          (i.status = function (e, t, n, i, r, a, s, l, c) {
            ...
            for (var u = 0; u < i; u += 1) e.lineTo(t + u, n + 7 - (u < a ? r * o.clamp(0.4 * c(u), -2, 2) : 0));
            e.stroke(),
              (e.fillStyle = "hsl(" + o.clamp(25 + 95 * l, 0, 120) + ",100%,60%)"),
            ...
            for (var n = t, i = 0; i < e.length; i++) {
              ...
              if (r.render.visible && r.pointA && r.pointB) {
                var a,
                  ...
                  c = r.bodyA,
                  u = r.bodyB;
                if (((a = c ? l.add(c.position, r.pointA) : r.pointA), "pin" === r.render.type))
                  n.beginPath(), n.arc(a.x, a.y, 3, 0, 2 * Math.PI), n.closePath();
                else {
                  if (
                    ...
                    for (
                      ...
                      (d = m % 2 == 0 ? 1 : -1),
                        n.lineTo(a.x + p.x * (m / v) + f.x * d * 4, a.y + p.y * (m / v) + f.y * d * 4);
                  n.lineTo(s.x, s.y);
                }
                r.render.lineWidth &&
                  ((n.lineWidth = r.render.lineWidth), (n.strokeStyle = r.render.strokeStyle), n.stroke()),
                  r.render.anchors &&
                  ...
                  if ((o = i.parts[a]).render.visible) {
                    if (
                      (l.showSleeping && i.isSleeping
                        ...
                        : 1 !== o.render.opacity && (s.globalAlpha = o.render.opacity),
                      ...
                      if (o.circleRadius)
                        s.beginPath(), s.arc(o.position.x, o.position.y, o.circleRadius, 0, 2 * Math.PI);
                      else {
                      ...
                      l.wireframes
                        ...
                        : ((s.fillStyle = o.render.fillStyle),
                          o.render.lineWidth &&
                            ((s.lineWidth = o.render.lineWidth), (s.strokeStyle = o.render.strokeStyle), s.stroke()),
                          s.fill());
                    }
                    s.globalAlpha = 1;
                  }
                  ...
                  for (o = i.parts[s], l.moveTo(o.vertices[0].x, o.vertices[0].y), a = 1; a < o.vertices.length; a++)
                    !o.vertices[a - 1].isInternal || c
                      ...
                      o.vertices[a].isInternal &&
                        !c &&
                        l.moveTo(o.vertices[(a + 1) % o.vertices.length].x, o.vertices[(a + 1) % o.vertices.length].y);
                  ...
                  for (r = u.length > 1 ? 1 : 0; r < u.length; r++)
                    for (i = u[r], a = 0; a < i.axes.length; a++)
                      s.moveTo(i.position.x, i.position.y),
                        s.lineTo(
                          (i.vertices[0].x + i.vertices[i.vertices.length - 1].x) / 2,
                          (i.vertices[0].y + i.vertices[i.vertices.length - 1].y) / 2
                        );
            }
            l.wireframes
          ...
          (i.bodyPositions = function (e, t, n) {
            ...
            for (
              l.wireframes ? (s.fillStyle = "indianred") : (s.fillStyle = "rgba(0,0,0,0.5)"),
                s.fill(),
                s.beginPath(),
                r = 0;
              r < t.length;
              ...
              (i = t[r]).render.visible &&
                (s.arc(i.positionPrev.x, i.positionPrev.y, 2, 0, 2 * Math.PI, !1), s.closePath());
          ...
          (i.collisions = function (e, t, n) {
            ...
            for (
              l.wireframes ? (s.fillStyle = "rgba(255,255,255,0.7)") : (s.fillStyle = "orange"),
                s.fill(),
                s.beginPath(),
                r = 0;
              r < t.length;
              ...
              if ((i = t[r]).isActive && ((o = i.collision), i.activeContacts.length > 0)) {
                ...
                2 === i.activeContacts.length &&
                  ((u = (i.activeContacts[0].vertex.x + i.activeContacts[1].vertex.x) / 2),
        ...
        (i.update = function (e, t, n) {
          ...
          for (
            s.update(A, w, P),
              ...
              A.collisionStart.length > 0 && c.trigger(e, "collisionStart", { pairs: A.collisionStart }),
          ...
          return (
            A.collisionActive.length > 0 && c.trigger(e, "collisionActive", { pairs: A.collisionActive }),
            A.collisionEnd.length > 0 && c.trigger(e, "collisionEnd", { pairs: A.collisionEnd }),
          ...
          for (n = 0; n < e.length; n++)
            (o = e[n]).isActive &&
              ...
              (u = r.sub(
                ...
                r.add(s.positionImpulse, r.sub(l.position, a.penetration, v), m),
                y
              )),
            ...
            if (((n.totalContacts = 0), 0 !== n.positionImpulse.x || 0 !== n.positionImpulse.y)) {
              ...
              (n.positionPrev.x += n.positionImpulse.x),
                ...
                r.dot(n.positionImpulse, n.velocity) < 0
                  ...
                  : ((n.positionImpulse.x *= i._positionWarming), (n.positionImpulse.y *= i._positionWarming));
            }
          }
        }),
        (i.preSolveVelocity = function (e) {
          ...
          for (t = 0; t < e.length; t++)
            if ((i = e[t]).isActive && !i.isSensor)
              for (
                o = i.activeContacts, s = (a = i.collision).parentA, l = a.parentB, c = a.normal, u = a.tangent, n = 0;
                n < o.length;
                n++
              )
                (p = (d = o[n]).vertex),
          ...
          for (
            ...
            if (f.isActive && !f.isSensor) {
              ...
              for (var S = 0; S < h.length; S++) {
                ...
                if (((E *= H), (V *= H), k < 0 && k * k > i._restingThresh * n)) w.normalImpulse = 0;
                else {
      ...
      (i._pairMaxIdleLife = 1e3),
        ...
        (i.update = function (e, t, n) {
          var i,
            ...
            d = e.collisionEnd,
            p = e.collisionActive;
          for (u.length = 0, d.length = 0, p.length = 0, s = 0; s < l.length; s++) l[s].confirmedActive = !1;
          for (s = 0; s < t.length; s++)
            (i = t[s]).collided &&
              ((a = c[(r = o.id(i.bodyA, i.bodyB))])
                ? (a.isActive ? p.push(a) : u.push(a), o.update(a, i, n), (a.confirmedActive = !0))
        ...
        (i.removeOld = function (e, t) {
          ...
          for (a = 0; a < c.length; a++) delete l[(n = s[(r = c[a] - a)]).id], s.splice(r, 1);
        }),
        (i.clear = function (e) {
          return (
            (e.table = {}),
    ...
    function (e, t, n) {
      ...
      (i.create = function (e) {
                ...
                for (a = m.startCol; a <= m.endCol; a++)
                  for (s = m.startRow; s <= m.endRow; s++) {
                    ...
                    !y && g && g && l && i._bucketRemoveBody(e, l, f),
                      (f.region === v || (y && !g) || o) &&
                        (l || (l = i._createBucket(d, c)), i._bucketAddBody(e, l, f));
                  }
                (f.region = v), (p = !0);
              }
            }
        ...
        (i._createRegion = function (e, t, n, i) {
          return { id: e + "," + t + "," + n + "," + i, startCol: e, endCol: t, startRow: n, endRow: i };
        }),
    ...
    function (e, t, n) {
      ...
      (i.stack = function (e, t, n, i, r, a, l) {
        for (var c, u = o.create({ label: "Stack" }), d = e, p = t, f = 0, v = 0; v < i; v++) {
        ...
        (i.mesh = function (e, t, n, i, s) {
          ...
          for (l = 0; l < n; l++) {
            for (c = 1; c < t; c++)
              (u = f[c - 1 + l * t]),
                (d = f[c + l * t]),
                o.addConstraint(e, r.create(a.extend({ bodyA: u, bodyB: d }, s)));
            if (l > 0)
              for (c = 0; c < t; c++)
                (u = f[c + (l - 1) * t]),
                  (d = f[c + l * t]),
                  ...
                  i &&
                    c > 0 &&
                    ((p = f[c - 1 + (l - 1) * t]), o.addConstraint(e, r.create(a.extend({ bodyA: p, bodyB: d }, s)))),
                  i &&
                    c < t - 1 &&
                    ((p = f[c + 1 + (l - 1) * t]), o.addConstraint(e, r.create(a.extend({ bodyA: p, bodyB: d }, s))));
          }
        ...
        (i.pyramid = function (e, t, n, o, r, a, l) {
          return i.stack(e, t, n, o, r, a, function (t, i, a, c, u, d) {
            ...
            if (!(c > p || a < (c = p - c) || a > n - 1 - c))
              return (
                1 === d && s.translate(u, { x: (a + (n % 2 == 1 ? 1 : -1)) * f, y: 0 }),
                l(e + (u ? a * f : 0) + a * r, i, a, c, u, d)
              );
          });
        }),
        (i.newtonsCradle = function (e, t, n, i, a) {
          for (var s = o.create({ label: "Newtons Cradle" }), c = 0; c < n; c++) {
        ...
        (i.car = function (e, t, n, i, a) {
          var c = s.nextGroup(!0),
            ...
            f = l.rectangle(e, t, n, i, { collisionFilter: { group: c }, chamfer: { radius: 0.5 * i }, density: 2e-4 }),
            v = l.circle(e + u, t + 0, a, { collisionFilter: { group: c }, friction: 0.8 }),
            m = l.circle(e + d, t + 0, a, { collisionFilter: { group: c }, friction: 0.8 }),
            y = r.create({ bodyB: f, pointB: { x: u, y: 0 }, bodyA: v, stiffness: 1, length: 0 }),
            g = r.create({ bodyB: f, pointB: { x: d, y: 0 }, bodyA: m, stiffness: 1, length: 0 });
        ...
        (i.softBody = function (e, t, n, o, r, s, c, u, d, p) {
          (d = a.extend({ inertia: 1 / 0 }, d)),
            (p = a.extend({ stiffness: 0.2, render: { type: "line", anchors: !1 } }, p));
    ...
    function (e, t, n) {
      ...
      (i.create = function (e, t) {
        ...
        (i.update = function (e, t) {
          ...
          if (0 === n.button) {
            if (i.bodyB) r.set(i.bodyB, !1), (i.pointA = n.position);
              ...
              for (var c = 0; c < t.length; c++)
                if (
                  ((a = t[c]), p.contains(a.bounds, n.position) && l.canCollide(a.collisionFilter, e.collisionFilter))
                )
                  for (var u = a.parts.length > 1 ? 1 : 0; u < a.parts.length; u++) {
                    ...
                    if (o.contains(d.vertices, n.position)) {
                      (i.pointA = n.position),
                        (i.bodyB = e.body = a),
                        (i.pointB = { x: n.position.x - a.position.x, y: n.position.y - a.position.y }),
                        (i.angleB = a.angle),
                        r.set(a, !1),
          ...
          } else (i.bodyB = e.body = null), (i.pointB = null), a && s.trigger(e, "enddrag", { mouse: n, body: a });
        }),
      ...
      (i.collides = function (e, t) {
        for (var n = [], i = 0; i < t.length; i++) {
          ...
          if (a.overlaps(o.bounds, e.bounds))
            for (var s = 1 === o.parts.length ? 0 : 1; s < o.parts.length; s++) {
              var l = o.parts[s];
            ...
            o.trigger(e, "beforeTick", l),
              e.isFixed
                ...
                : ((i = n - e.timePrev || e.delta),
                  ...
                  (s =
                    (i =
                      (i = (i = Math.min.apply(null, e.deltaHistory)) < e.deltaMin ? e.deltaMin : i) > e.deltaMax
                        ? e.deltaMax
                        : i) / e.delta),
                  (e.delta = i)),
